...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Cardiff Express","Belfast Express","Derby Express","Chester Express","Newport Express"}; //Name of Buses
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
int main()
{
    ...
    system("cls");
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\t*******************************************************************************************************\n");
    printf("\t\t\t\t\t You have successfully logged out of TRAVELPRO.\t\t\t\t\t\t\n");
    printf("\t\t\t\t\t         Thank you for using TRAVELPRO.\t\t\t\t\t\t\n");
    printf("\t*******************************************************************************************************\n");
    getch();
    return 0;
}
    ...
    do
{
	...
	{
	printf("  \n\n\n                        WELCOME TO TRAVELPRO BUS AGENCY!!!! LOGIN IS SUCCESSFUL....");
	...
	if (a>2)
	{
		printf("\n\n\n\t\t\tYou have reached the maximum login attempts. Exit and try again.");
